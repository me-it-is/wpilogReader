...
use crate::shared::shared::{WpilogReadErrors, pad_to_n_bytes, next_chunk};
use crate::control_records::control_records::{StartRecordData, FinishRecordData, SetMetaDataRecordData, process_control_record};
#[allow(dead_code)]
#[derive(Debug, Clone)]
...
impl EntryData {
    pub fn new(start_record_index: u32, name: String, data_type: DataType, metadata: Metadata) -> EntryData{
        EntryData { start_record_index, name, data_type, metadata, finish_record_index: None }
    }
}
#[allow(dead_code)]
#[derive(Debug, Clone)]
